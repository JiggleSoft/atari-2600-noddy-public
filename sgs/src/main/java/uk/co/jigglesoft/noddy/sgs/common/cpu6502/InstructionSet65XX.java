...
public enum InstructionSet65XX
{
    ...
    ORA_XIN(0x01, Mnemonic6502.ORA, INDEXED_X_INDIRECT),
    JAM_IMP_02(0x02, Mnemonic6502.JAM, IMPLIED, true, KABOOM),
    SLO_XIN(0x03, Mnemonic6502.SLO, INDEXED_X_INDIRECT, true, STABLE),
    ...
    AND_XIN(0x21, Mnemonic6502.AND, INDEXED_X_INDIRECT),
    JAM_IMP_22(0x22, Mnemonic6502.JAM, IMPLIED, true, KABOOM),
    RLA_XIN(0x23, Mnemonic6502.RLA, INDEXED_X_INDIRECT, true, STABLE),
    ...
    EOR_XIN(0x41, Mnemonic6502.EOR, INDEXED_X_INDIRECT),
    JAM_IMP_42(0x42, Mnemonic6502.JAM, IMPLIED, true, KABOOM),
    SRE_XIN(0x43, Mnemonic6502.SRE, INDEXED_X_INDIRECT, true, STABLE),
    ...
    SRE_INY(0x53, Mnemonic6502.SRE, INDIRECT_INDEXED_Y, true, STABLE),
    NOP_ZPX(0x54, Mnemonic6502.NOP, ZERO_PAGE_INDEXED_X, true, STABLE),
    EOR_ZPX(0x55, Mnemonic6502.EOR, ZERO_PAGE_INDEXED_X),
    LSR_ZPX(0x56, Mnemonic6502.LSR, ZERO_PAGE_INDEXED_X),
    SRE_ZPX(0x57, Mnemonic6502.SRE, ZERO_PAGE_INDEXED_X, true, STABLE),
    CLI_IMP(0x58, Mnemonic6502.CLI, IMPLIED),
    EOR_ABY(0x59, Mnemonic6502.EOR, ABSOLUTE_INDEXED_Y),
    NOP_IMP_5A(0x5A, Mnemonic6502.NOP, IMPLIED, true, STABLE),
    SRE_ABY(0x5B, Mnemonic6502.SRE, ABSOLUTE_INDEXED_Y, true, STABLE),
    NOP_ABX_53(0x5C, Mnemonic6502.NOP, ABSOLUTE_INDEXED_X, true, STABLE),
    EOR_ABX(0x5D, Mnemonic6502.EOR, ABSOLUTE_INDEXED_X),
    LSR_ABX(0x5E, Mnemonic6502.LSR, ABSOLUTE_INDEXED_X),
    SRE_ABX(0x5F, Mnemonic6502.SRE, ABSOLUTE_INDEXED_X, true, STABLE),
    RTS_IMP(0x60, Mnemonic6502.RTS, IMPLIED),
    ADC_XIN(0x61, Mnemonic6502.ADC, INDEXED_X_INDIRECT),
    JAM_IMP_62(0x62, Mnemonic6502.JAM, IMPLIED, true, KABOOM),
    RRA_XIN(0x63, Mnemonic6502.RRA, INDEXED_X_INDIRECT, true, STABLE),
    ...
    RRA_INY(0x73, Mnemonic6502.RRA, INDIRECT_INDEXED_Y, true, STABLE),
    ...
    RRA_ZPX(0x77, Mnemonic6502.RRA, ZERO_PAGE_INDEXED_X, true, STABLE),
    SEI_IMP(0x78, Mnemonic6502.SEI, IMPLIED),
    ADC_ABY(0x79, Mnemonic6502.ADC, ABSOLUTE_INDEXED_Y),
    NOP_IMP_7A(0x7A, Mnemonic6502.NOP, IMPLIED, true, STABLE),
    RRA_ABY(0x7B, Mnemonic6502.RRA, ABSOLUTE_INDEXED_Y, true, STABLE),
    NOP_ABX_7C(0x7C, Mnemonic6502.NOP, ABSOLUTE_INDEXED_X, true, STABLE),
    ADC_ABX(0x7D, Mnemonic6502.ADC, ABSOLUTE_INDEXED_X),
    ROR_ABX(0x7E, Mnemonic6502.ROR, ABSOLUTE_INDEXED_X),
    RRA_ABX(0x7F, Mnemonic6502.RRA, ABSOLUTE_INDEXED_X, true, STABLE),
    NOP_IMM(0x80, Mnemonic6502.NOP, IMMEDIATE, true, STABLE),
    STA_XIN(0x81, Mnemonic6502.STA, INDEXED_X_INDIRECT),
    NOP_IMM_82(0x82, Mnemonic6502.NOP, IMMEDIATE, true, STABLE),
    SAX_XIN(0x83, Mnemonic6502.SAX, INDEXED_X_INDIRECT, true, STABLE),
    STY_ZPG(0x84, Mnemonic6502.STY, ZERO_PAGE),
    STA_ZPG(0x85, Mnemonic6502.STA, ZERO_PAGE),
    STX_ZPG(0x86, Mnemonic6502.STX, ZERO_PAGE),
    SAX_ZPG(0x87, Mnemonic6502.SAX, ZERO_PAGE, true, STABLE),
    DEY_IMP(0x88, Mnemonic6502.DEY, IMPLIED),
    NOP_IMM_89(0x89, Mnemonic6502.NOP, IMMEDIATE, true, STABLE),
    ...
    STX_ABS(0x8E, Mnemonic6502.STX, ABSOLUTE),
    SAX_ABS(0x8F, Mnemonic6502.SAX, ABSOLUTE, true, STABLE),
    ...
    SAX_ZPY(0x97, Mnemonic6502.SAX, ZERO_PAGE_INDEXED_Y, true, STABLE),
    ...
    LDA_XIN(0xA1, Mnemonic6502.LDA, INDEXED_X_INDIRECT),
    LDX_IMM(0xA2, Mnemonic6502.LDX, IMMEDIATE),
    LAX_XIN(0xA3, Mnemonic6502.LAX, INDEXED_X_INDIRECT, true, STABLE),
    LDY_ZPG(0xA4, Mnemonic6502.LDY, ZERO_PAGE),
    LDA_ZPG(0xA5, Mnemonic6502.LDA, ZERO_PAGE),
    LDX_ZPG(0xA6, Mnemonic6502.LDX, ZERO_PAGE),
    LAX_ZPG(0xA7, Mnemonic6502.LAX, ZERO_PAGE, true, STABLE),
    ...
    LAX_ABS(0xAF, Mnemonic6502.LAX, ABSOLUTE, true, STABLE),
    ...
    LAX_INY(0xB3, Mnemonic6502.LAX, INDIRECT_INDEXED_Y, true, STABLE),
    LDY_ZPX(0xB4, Mnemonic6502.LDY, ZERO_PAGE_INDEXED_X),
    LDA_ZPX(0xB5, Mnemonic6502.LDA, ZERO_PAGE_INDEXED_X),
    LDX_ZPY(0xB6, Mnemonic6502.LDX, ZERO_PAGE_INDEXED_Y),
    LAX_ZPY(0xB7, Mnemonic6502.LAX, ZERO_PAGE_INDEXED_Y, true, STABLE),
    ...
    LAS_ABY(0xBB, Mnemonic6502.LAS, ABSOLUTE_INDEXED_Y, true, STABLE),
    ...
    DCP_INY(0xD3, Mnemonic6502.DCP, INDIRECT_INDEXED_Y, true, STABLE),
    NOP_ZPX_D4(0xD4, Mnemonic6502.NOP, ZERO_PAGE_INDEXED_X, true, STABLE),
    CMP_ZPX(0xD5, Mnemonic6502.CMP, ZERO_PAGE_INDEXED_X),
    DEC_ZPX(0xD6, Mnemonic6502.DEC, ZERO_PAGE_INDEXED_X),
    DCP_ZPX(0xD7, Mnemonic6502.DCP, ZERO_PAGE_INDEXED_X, true, STABLE),
    CLD_IMP(0xD8, Mnemonic6502.CLD, IMPLIED),
    CMP_ABY(0xD9, Mnemonic6502.CMP, ABSOLUTE_INDEXED_Y),
    NOP_IMP_DA(0xDA, Mnemonic6502.NOP, IMPLIED, true, STABLE),
    DCP_ABY(0xDB, Mnemonic6502.DCP, ABSOLUTE_INDEXED_Y, true, STABLE),
    NOP_ABX_DC(0xDC, Mnemonic6502.NOP, ABSOLUTE_INDEXED_X, true, STABLE),
    CMP_ABX(0xDD, Mnemonic6502.CMP, ABSOLUTE_INDEXED_X),
    DEC_ABX(0xDE, Mnemonic6502.DEC, ABSOLUTE_INDEXED_X),
    DCP_ABX(0xDF, Mnemonic6502.DCP, ABSOLUTE_INDEXED_X, true, STABLE),
    CPX_IMM(0xE0, Mnemonic6502.CPX, IMMEDIATE),
    SBC_XIN(0xE1, Mnemonic6502.SBC, INDEXED_X_INDIRECT),
    NOP_IMM_E2(0xE2, Mnemonic6502.NOP, IMMEDIATE, true, STABLE),
    ISC_XIN(0xE3, Mnemonic6502.ISC, INDEXED_X_INDIRECT, true, STABLE),
    CPX_ZPG(0xE4, Mnemonic6502.CPX, ZERO_PAGE),
    SBC_ZPG(0xE5, Mnemonic6502.SBC, ZERO_PAGE),
    INC_ZPG(0xE6, Mnemonic6502.INC, ZERO_PAGE),
    ISC_ZPG(0xE7, Mnemonic6502.ISC, ZERO_PAGE, true, STABLE),
    INX_IMP(0xE8, Mnemonic6502.INX, IMPLIED),
    SBC_IMM(0xE9, Mnemonic6502.SBC, IMMEDIATE),
    NOP_IMP(0xEA, Mnemonic6502.NOP, IMPLIED),
    SBC_IMM_EB(0xEB, Mnemonic6502.SBC, IMMEDIATE, true, STABLE),
    CPX_ABS(0xEC, Mnemonic6502.CPX, ABSOLUTE),
    SBC_ABS(0xED, Mnemonic6502.SBC, ABSOLUTE),
    INC_ABS(0xEE, Mnemonic6502.INC, ABSOLUTE),
    ISC_ABS(0xEF, Mnemonic6502.ISC, ABSOLUTE, true, STABLE),
    ...
    ISC_INY(0xF3, Mnemonic6502.ISC, INDIRECT_INDEXED_Y, true, STABLE),
    NOP_ZPX_F4(0xF4, Mnemonic6502.NOP, ZERO_PAGE_INDEXED_X, true, STABLE),
    SBC_ZPX(0xF5, Mnemonic6502.SBC, ZERO_PAGE_INDEXED_X),
    INC_ZPX(0xF6, Mnemonic6502.INC, ZERO_PAGE_INDEXED_X),
    ISC_ZPX(0xF7, Mnemonic6502.ISC, ZERO_PAGE_INDEXED_X, true, STABLE),
    SED_IMP(0xF8, Mnemonic6502.SED, IMPLIED),
    SBC_ABY(0xF9, Mnemonic6502.SBC, ABSOLUTE_INDEXED_Y),
    NOP_IMP_FA(0xFA, Mnemonic6502.NOP, IMPLIED, true, STABLE),
    ISC_ABY(0xFB, Mnemonic6502.ISC, ABSOLUTE_INDEXED_Y, true, STABLE),
    NOP_ABX_FC(0xFC, Mnemonic6502.NOP, ABSOLUTE_INDEXED_X, true, STABLE),
    SBC_ABX(0xFD, Mnemonic6502.SBC, ABSOLUTE_INDEXED_X),
    INC_ABX(0xFE, Mnemonic6502.INC, ABSOLUTE_INDEXED_X),
    ISC_ABX(0xFF, Mnemonic6502.ISC, ABSOLUTE_INDEXED_X, true, STABLE);
